        ...
        try {
            ...
            try {
                if (typeof chrome !== 'undefined' && browser.runtime && browser.runtime.sendMessage) {
                    ...
                    console.log('🔧 DEBUG: Extension ID:', browser.runtime.id);
                        ...
                        response = await new Promise((resolve, reject) => {
                            ...
                            browser.runtime.sendMessage(messageData, (response) => {
                                ...
                                if (browser.runtime.lastError) {
                                    console.log('🔧 DEBUG: Runtime error:', browser.runtime.lastError.message);
                    ...
                    if (success) {
                        ...
                        try {
                            ...
                            await browser.storage.local.set(directStorage);
                    ...
                    console.log('🔧 DEBUG: browser.runtime:', typeof chrome?.runtime);
                    console.log('🔧 DEBUG: browser.runtime.sendMessage:', typeof chrome?.runtime?.sendMessage);
    ...
    if (typeof chrome !== 'undefined' && browser.runtime) {
        ...
        try {
            browser.runtime.sendMessage({
                ...
                if (browser.runtime.lastError) {
                    console.log('🔧 DEBUG: Connection test failed:', browser.runtime.lastError.message);
                } else {
