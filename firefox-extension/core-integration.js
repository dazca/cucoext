...
class CoreIntegration {
    ...
    async getWorkStatus(forceRefresh = false) {
        try {
            ...
            const storage = await browser.storage.local.get(['customMarcajesEnabled', 'customMarcajesData', 'bypassCredentialsEnabled']);
    ...
    async getDebugWorkStatus(customMarcajesData) {
        try {
            ...
            const storage = await browser.storage.local.get(['timeToLeaveOverride', 'overrideDate', 'timeToLeaveFirstShown', 'firstShownDate']);
